...
class ApiClient {
  ...
  Future<void> changeUsername(String username, String password) async {
    await _request('PUT', '/api/me/username', body: {'new_username': username, 'current_password': password});
  }

  Future<void> changePassword(String currentPassword, String newPassword) async {
    await _request('PUT', '/api/me/password', body: {'current_password': currentPassword, 'new_password': newPassword});
    final prefs = await SharedPreferences.getInstance();
    await prefs.remove('token');
  }
